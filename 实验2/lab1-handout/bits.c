 ...
 * CS:APP Data Lab
 *
 * <Please put your name and userid here> 1170300817
 *
...
int subOK(int x, int y)
{
    int fl1 = (x >> 31) & 0x1;
    int fl2 = (y >> 31) & 0x1;
    int fl3 = ((x + (~y +1)) >> 31) & 0x1;
    return ((fl1 & fl2)|(fl2 ^ fl3)) | ((!fl1 & !fl2)|(!fl2 ^ !fl3)) ;
}
/*
